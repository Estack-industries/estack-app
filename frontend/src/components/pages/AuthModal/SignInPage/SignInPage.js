  ...
  return (
    <>
      ...
      {/*temporaroly add this to view logginStatus */}
        ...
        <h3 className="authEmail">Email <span className = "Warning-Text">{emailStatus}</span></h3>
        <EmailPassBox text={AUTH_EMAIL} onChange = {(e) => {
        setEmail(e.target.value);}} />
        <h3 className="authPassword">Password <span className = "Warning-Text">{passwordStatus}</span></h3>
