            ...
            <div>
                ...
                <div className="firstSectionContainer">
                    <div className="chooseBox">
                        ...
                        <p className="boxText">You’ll be in direct contact with the landlord/agent and he’ll help you sort out any doubts that you may have</p>
                    </div>
                    <div className="chooseBox">
                        <p className="boxImg"><img src={Details} alt="Details Pic" /></p>
                        <p className="boxText">We give you the details and every requirement that is needed for you to buy, rent or sell</p>
                    </div>
                    <div className="chooseBox">
                        <p className="boxImg"><img src={Deal} alt="Deal Pic" /></p>
                        <p className="boxText">We help you close the deal of your dream home</p>
                    </div>
                </div>
            </div>
                ...
                <div className="secondSectionContainer">
                    <Link to="/" className="listingBoxContainer">
                        <div className="listingBox">
                            <img src={Listing1} alt="First Listing" className="cardImg" />
                            <div className="listingBottom">
                                <p className="listingTitle">Ventura St. 3892, St Louis</p>
                    ...
                    <Link to="/" className="listingBoxContainer">
                        <div className="listingBox">
                            <img src={Listing2} alt="Second Listing" className="cardImg" />
                            <div className="listingBottom">
                                <p className="listingTitle">Ventura St. 3892, St Louis</p>
                                <div className="listingStats">
                                    <p className="listingPrice">600.000$</p>
                    ...
                    <Link to="/" className="listingBoxContainer">
                        <div className="listingBox">
                            <img src={Listing3} alt="Third Listing" className="cardImg"/>
                            <div className="listingBottom">
                                <p className="listingTitle">Ventura St. 3892, St Louis</p>
                                <div className="listingStats">
                                    <p className="listingPrice">600.000$</p>
